						...
						<div class="card-box-b card-shadow news-box">
							...
							<div class="card-overlay">
								<div class="card-header-b">
									...
									<div class="card-date">
										<h3 class="date-b">
											<center>Đã có 1,600* lượt khách</center>
										</h3>
									</div>
								</div>
							</div>
						...
						<div class="card-box-b card-shadow news-box">
							...
							<div class="card-overlay">
								<div class="card-header-b">
									<div class="card-title-b">
										<h2 class="title-2">
											<a href="blog-single.html"><center>Sa Pa</center> </a>
										</h2>
									</div>
									<div class="card-date">
						...
						<div class="card-box-b card-shadow news-box">
							...
							<div class="card-overlay">
								<div class="card-header-b">
									<div class="card-title-b">
										<h2 class="title-2">
											<a href="blog-single.html"><center>Qui Nhơn</center> </a>
										</h2>
									</div>
									<div class="card-date">
						...
						<div class="card-box-b card-shadow news-box">
							...
							<div class="card-overlay">
								<div class="card-header-b">
									<div class="card-title-b">
										<h2 class="title-2">
											<a href="#"><center>Đà Nẵng</center> </a>
										</h2>
									</div>
									<div class="card-date">
								...
								<div class="col-sm-12 col-md-6">
									...
									<div class="testimonials-content">
										<p class="testimonial-text">
											1. MẠNG BÁN TOUR <br> Ứng dụng hàng tại Việt Nam<br>
											Ứng dụng công nghệ mới nhất.
										</p>
									</div>
									<div class="testimonials-content">
										<p class="testimonial-text">
											2.THANH TOÁN<br> An toàn và linh hoạt<br> Liên kết
											với các tổ chức tài chính.
										</p>
									</div>
									<div class="testimonials-content">
										<p class="testimonial-text">
											3. GIÁ CẢ <br> Ứng dụng hàng tại Việt Nam<br> Ứng
											dụng công nghệ mới nhất.
										</p>
									</div>
									<div class="testimonials-content">
										<p class="testimonial-text">
											4. SẢN PHẨM <br> Đa dạng chất lượng<br> Đạt chất
											lượng tốt nhất
										</p>
									</div>
									<div class="testimonials-content">
										<p class="testimonial-text">
											5. ĐẶT TOUR <br> Dễ dàng và nhanh chóng<br> Đặt
											tour chỉ với 3 bước.
										</p>
									</div>
