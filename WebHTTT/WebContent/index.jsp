					...
					<div class="card-box-a card-shadow">
						...
						<div class="card-overlay">
							<div class="card-overlay-a-content">
								<div class="card-header-a">
									<h2 class="card-title-a">
										<a href="property-single.html">Tour Mỹ - Los Angeles- Hollywood <br />
										</a>
									</h2>
								</div>
								<div class="card-body-a">
								...
								<div class="card-footer-a">
									<ul class="card-info d-flex justify-content-around">
										...
										<li>
											<h4 class="card-info-title">Khách sạn</h4> <span>Crowne </span>
										</li>
										<li>
											<h4 class="card-info-title">Phương tiện</h4> <span>Limousine
												bus</span>
					...
					<div class="card-box-a card-shadow">
						...
						<div class="card-overlay">
							<div class="card-overlay-a-content">
								<div class="card-header-a">
									<h2 class="card-title-a">
										<a href="property-single.html">Tour Anh - Luân Đôn - Manchester
											<br />
										</a>
									</h2>
								</div>
								...
								<div class="card-footer-a">
									<ul class="card-info d-flex justify-content-around">
										...
										<li>
											<h4 class="card-info-title">Khách sạn</h4> <span>Asernal </span>
										</li>
										<li>
											<h4 class="card-info-title">Phương tiện</h4> <span>Limousine
												bus</span>
					...
					<div class="card-box-a card-shadow">
						...
						<div class="card-overlay">
							<div class="card-overlay-a-content">
								<div class="card-header-a">
									<h2 class="card-title-a">
										<a href="property-single.html">Tour Hàn Quốc - Seoul  - Osaka <br />
										</a>
									</h2>
								</div>
								<div class="card-body-a">
								...
								<div class="card-footer-a">
									<ul class="card-info d-flex justify-content-around">
										...
										<li>
											<h4 class="card-info-title">Khách sạn</h4> <span>Everland  </span>
										</li>
										<li>
											<h4 class="card-info-title">Phương tiện</h4> <span>Limousine
												bus</span>
