...
INSERT INTO `booktour` VALUES (6,3,2,'','2019-12-26',9,9,1,'ktx khu f đại học nông lâm','ktx khu f đại học nông lâm','0949630817','DU LỊCH NHA TRANG ');
...
CREATE TABLE `tour` (
  ...
  `customer_seat` int(255) DEFAULT NULL,
