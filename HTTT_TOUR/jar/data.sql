...
CREATE TABLE `thanhtoan` (
  ...
  CONSTRAINT `thanhtoan_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_db` (`user_id`),
  CONSTRAINT `thanhtoan_ibfk_2` FOREIGN KEY (`phone_id`) REFERENCES `phone` (`id`)
...
INSERT INTO `thanhtoan` VALUES (2,47,1,'2019-12-19',1,NULL,NULL),(3,31,1,'2019-12-19',3,NULL,NULL),(3,47,1,'2019-12-20',4,NULL,NULL),(3,36,1,'2019-12-20',5,NULL,NULL),(3,47,1,'2019-12-20',6,NULL,NULL),(3,37,1,'2019-12-20',7,NULL,NULL),(3,37,1,'2019-12-20',8,NULL,NULL),(3,47,1,'2019-12-20',9,NULL,NULL),(3,37,1,'2019-12-20',10,NULL,NULL),(2,41,1,'2019-12-20',11,NULL,NULL),(2,15,1,'2019-12-21',13,NULL,NULL),(8,36,1,'2019-12-22',14,'hcm','0943550345'),(13,47,1,'2019-12-22',15,'alo','0977376754'),(21,37,1,'2019-12-22',16,'NLU','0977376754'),(21,47,0,'2019-12-22',17,'NLU','0977376754');
...
INSERT INTO `user_db` VALUES (1,'ltn','123','lethanhnghi',1,NULL,NULL,NULL),(2,'zxc','123','Lê Thanh Nghị',2,'0123456789','ltn@gmail.com','123 quang trung'),(3,'asd','123','Lê Thanh Nghị',2,'0123456789','lethanhnghi9x@gmail.com','kp 6 linh trung thủ đức'),(4,'ghj','123',NULL,2,NULL,NULL,NULL),(8,'vvn','123','vo van nghi',2,'0943550345','vonghi166@gmail.com','zzzzzzz'),(13,'nhatdeptrai','123','Đào Quang Nhật',2,'0977376754','asdsa@asfka.sdcfdsa','alo'),(20,'nhatdepvl','123',NULL,2,NULL,NULL,NULL),(21,'nghingu','123','VÕ văn nghị',2,'0977376754','nghingu@gmail.com','NLU');
/*!40000 ALTER TABLE `user_db` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'ltw'
--
...
-- Dump completed on 2019-12-25 14:28:25
