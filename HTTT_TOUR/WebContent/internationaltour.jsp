...
<head>
<title>Danh sách tour nước ngoài</title>
<meta charset="utf-8">
<meta name="viewport"
		...
		<div class="container py-1">
			<div class="row align-items-center">
				<div class="col-8 col-md-8 col-lg-4">
					<h1 class="">
						<a href="indexjsp" class="h5 text-uppercase text-black"><strong>HomeTourist<span
				...
				<div class="col-4 col-md-4 col-lg-8">
					<nav class="site-navigation text-right text-md-right"
						...
						<ul class="site-menu js-clone-nav d-none d-lg-block"
							...
							<li class="active"><a href="internationaltour.jsp">TOUR
									NƯỚC NGOÀI</a></li>
							<li><a href="./Login/login.jsp">ĐĂNG NHẬP</a></li>
							<li><a href="bookingjsp"><button
		...
		<div class="container">
			...
			<div class="card-salesoff">
				<div class="card sales" style="width: 400px; height: 500px">
					...
					<div class="card-block px-3">
						<h4 class="card-title">DU LỊCH NHẬT BẢN</h4>
						<h6 class="card-text-city">HÀ NỘI - NHẬT BẢN</h6>
						<p class="card-text">
							Thời gian: 3 ngày 3 đêm <br>Phương tiện : Hàng không Việt
							Nam Airlines
						</p>
				...
				<div class="card sales2" style="width: 400px; height: 500px">
					...
					<div class="card-block px-3">
						<h4 class="card-title">DU LỊCH PHÁP</h4>
						<h6 class="card-text-city">HÀ NỘI - PHÁP</h6>
						<p class="card-text">
			...
			<div class="card-salesoff">
				<div class="card sales" style="width: 400px; height: 500px">
					...
					<div class="card-block px-3">
						<h4 class="card-title">DU LỊCH HÀ LAN</h4>
						<h6 class="card-text-city">HÀ NỘI - HÀ LAN</h6>
						<p class="card-text">
							Thời gian: 5 ngày 4 đêm <br>Phương tiện : Hàng không Việt
							Nam Airlines
						</p>
						<input type="submit" value="Giá từ 3,739,000đ"
							class="form-control-date btn btn-primary">
				...
				<div class="card sales2" style="width: 400px; height: 500px">
					...
					<div class="card-block px-3">
						<h4 class="card-title">DU LỊCH PHẦN LAN</h4>
						<h6 class="card-text-city">HÀ NỘI - PHẦN LAN</h6>
						<p class="card-text">
							Thời gian: 5 ngày 4 đêm <br>Phương tiện : Hàng không Việt
							Nam Airlines
						</p>
				...
				<div class="card sales2" style="width: 400px; height: 500px">
					...
					<div class="card-block px-3">
						<h4 class="card-title">DU LỊCH Ý</h4>
						<h6 class="card-text-city">HÀ NỘI - Ý</h6>
						<p class="card-text">
							Thời gian: 3 ngày 3 đêm <br>Phương tiện : Hàng không Việt
							Nam Airlines
						</p>
				...
				<div class="row ">
					...
					<div class="row">
						<div class=".col-12 .col-md-8">
							<div class="card-block px-3">
								<h4 class="card-title">DU LỊCH ÁO</h4>
								<h6 class="card-text-city">HÀ NỘI - ÁO</h6>
								<p class="card-text">
									Thời gian: 4 ngày 3 đêm <br>Phương tiện : Hàng không Việt
									Nam Airlines <br>- Cơ hội tham quan nước Áo, đảm bảo chất
									lượng dịch vụ...
								</p>
							</div>
						</div>
			...
			<div class="card">
				<div class="row ">
					...
					<div class="row">
						<div class=".col-12 .col-md-8">
							<div class="card-block px-3">
								<h4 class="card-title">DU LỊCH ÚC</h4>
								<h6 class="card-text-city">HÀ NỘI - ÚC</h6>
								<p class="card-text">
									Thời gian: 4 ngày 3 đêm <br>Phương tiện : Hàng không Việt
									Nam Airlines <br>- Cơ hội tham quan xứ sở chuột túi, đảm
									bảo chất lượng ...
								</p>
							</div>
						</div>
			...
			<div class="card">
				<div class="row ">
					...
					<div class="row">
						<div class=".col-12 .col-md-8">
							<div class="card-block px-3">
								<h4 class="card-title">DU LỊCH NGA</h4>
								<h6 class="card-text-city">HÀ NỘI - NGA</h6>
								<p class="card-text">
									Thời gian: 4 ngày 3 đêm <br>Phương tiện : Hàng không Việt
									Nam Airlines <br>- Hành trình đón năm mới ở thành phố
									Moscow với thiên...
								</p>
							</div>
						</div>
			...
			<div class="card">
				<div class="row ">
					...
					<div class="row">
						<div class=".col-12 .col-md-8">
							<div class="card-block px-3">
								<h4 class="card-title">DU LỊCH SCOTLAND</h4>
								<h6 class="card-text-city">HÀ NỘI - SCOTLAND</h6>
								<p class="card-text">
									Thời gian: 4 ngày 3 đêm <br>Phương tiện : Hàng không Việt
									Nam Airlines <br>- Hành trình chiêm ngưỡng cung điện, lâu
									đài nguy nga ....
								</p>
							</div>
						</div>
			...
			<div class="card">
				<div class="row ">
					...
					<div class="row">
						<div class=".col-12 .col-md-8">
							<div class="card-block px-3">
								<h4 class="card-title">DU LỊCH ANH</h4>
								<h6 class="card-text-city">HÀ NỘI - ANH</h6>
								<p class="card-text">
									Thời gian: 4 ngày 3 đêm <br>Phương tiện : Hàng không Việt
									Nam Airlines <br>- Hành trình đón tết và chiêm ngưỡng thế
									giới cung điện,...
								</p>
							</div>
						</div>
			...
			<div class="card">
				<div class="row ">
					...
					<div class="row">
						<div class=".col-12 .col-md-8">
							<div class="card-block px-3">
								<h4 class="card-title">DU LICH SCOTLAND</h4>
								<h6 class="card-text-city">HÀ NỘI - SCOTLAND</h6>
								<p class="card-text">
									Thời gian: 4 ngày 3 đêm <br>Phương tiện : Hàng không Việt
									Nam Airlines <br>- Cơ hội thưởng ngoạn ở “xứ sở thảm bay”,
									vùng đất của ...
								</p>
							</div>
						</div>
			...
			<div class="card">
				<div class="row ">
					...
					<div class="row">
						<div class=".col-12 .col-md-8">
							<div class="card-block px-3">
								<h4 class="card-title">DU LỊCH HONG KONG</h4>
								<h6 class="card-text-city">HÀ NỘI - HONG KONG</h6>
								<p class="card-text">
									Thời gian: 4 ngày 3 đêm <br>Phương tiện : Hàng không Việt
									Nam Airlines <br>- Thỏa sức mua sắm tại những trung tâm
									thương mại lớn,...
								</p>
							</div>
						</div>
			...
			<div class="card">
				<div class="row ">
					...
					<div class="row">
						<div class=".col-12 .col-md-8">
							<div class="card-block px-3">
								<h4 class="card-title">DU LỊCH HÀN QUỐC</h4>
								<h6 class="card-text-city">HÀ NỘI - HÀN QUỐC</h6>
								<p class="card-text">
									Thời gian: 4 ngày 3 đêm <br>Phương tiện : Hàng không Việt
									Nam Airlines <br>- Cảm nhận không gian thi vị của những
									công trình kiến ....
								</p>
							</div>
						</div>
